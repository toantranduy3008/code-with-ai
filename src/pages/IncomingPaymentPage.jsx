...
export default function IncomingPaymentPage() {
    ...
    const handleConfirmDispute = async (id, values) => {
        ...
        const disputeData = {
            ...
            traceNo: selectedRecord?.traceNo || '',
            transRef: selectedRecord?.transRef || '',
            returnedAmount: selectedRecord?.returnedAmount || 0,
            rootAmount: selectedRecord?.amount || 0,
            fileAttachment: await generateFileAttachment(values.attachment)
        }
        try {
